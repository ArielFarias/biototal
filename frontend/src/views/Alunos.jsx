...
class Alunos extends React.Component {
  ...
  getAluno = () => {
    fetch("https://biologia-total.herokuapp.com:5001/api/alunos")
      .then(data => data.json())
      .then(res => this.setState({ alunos: res.data }));
  };

  createAluno = () => {
    axios.post("https://biologia-total.herokuapp.com:5001/api/aluno", {
  ...
  updateAluno = id => {
    ...
    axios.post(`https://biologia-total.herokuapp.com:5001/api/updateAluno/${id}`, {
      id,
      update: {
  ...
  deleteAluno = id => {
    axios.delete(`https://biologia-total.herokuapp.com:5001/api/aluno/${id}`, {
      data: {
        id
      }
    }).then(() => this.getAluno())
